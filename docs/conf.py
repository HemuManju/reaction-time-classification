# -*- coding: utf-8 -*-
#
# Reaction time classification documentation build configuration file,
# created by
# sphinx-quickstart.
#
...
project = u'Reaction time classification'
...
# html_title = 'Reaction time classification'
...
texinfo_documents = [
    ('index', 'Reaction time classification',
     ...
     'Classification of reaction time of an operator in tele-operation',
     'Miscellaneous'),
]
